...
echo "window.JiraData = { title: \"$TITLE\", data: $JIRA_DATA, settings:{sprint_fieldname: '$SPRINT_FIELDNAME', points_fieldname: '$POINTS_FIELDNAME', non_working_dates: $NON_WORKING_DATES} };" > $OUTPUT_FILENAME
